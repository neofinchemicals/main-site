...
import fineChemicals from "../../assets/images/1.jpg";
import pharmaceutical from "../../assets/images/2.jpg";
import agri from "../../assets/images/3.jpg";
import intermediates from "../../assets/images/4.jpg";
import pesticides from "../../assets/images/5.jpg";
...
const ProductCategories = () => {
  ...
  return (
    <section id="productCategories" className="max-w-6xl mx-auto px-4 py-16">
      <motion.section
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            >
              ...
              meet diverse industry needs with quality and sustainability in
              mind.
            </motion.p>
          </div>
                ...
                <div className="h-48 bg-blue-100 relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="bg-white/60 rounded px-3 py-1">
                      <h4 className="text-xl font-bold text-blue-950 text-center">
                        {product.name}
                      </h4>
                    </div>
                  </div>
